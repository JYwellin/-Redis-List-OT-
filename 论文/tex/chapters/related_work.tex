...
我们定义第一类函数为第一类操作之间的OT函数，即Ins,Del,Set三种操作之间的OT函数，共有3*3=9个。\cite{sun2014exhaustive}
...
我们定义第二类函数为第二类操作之间的OT函数，即Ins,Del两种区间操作之间的OT函数，共2*2=4个。\cite{Sun:2017:ESR:2998181.2998252}
